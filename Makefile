# This Makefile is for the Games::Quakeworld::Query extension to perl.
#
...
#     NAME => q[Games::Quakeworld::Query]
#     VERSION_FROM => q[Query.pm]
...
DISTNAME = Games-Quakeworld-Query
NAME_SYM = Games_Quakeworld_Query
VERSION = 0.33
VERSION_SYM = 0_33
XS_VERSION = 0.33
...
FULLEXT = Games/Quakeworld/Query
BASEEXT = Query
PARENT_NAME = Games::Quakeworld
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Games/Quakeworld
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Games/Quakeworld
...
manifypods : pure_all Query.pm
	@$(POD2MAN) \
	Query.pm \
	$(INST_MAN3DIR)/Games::Quakeworld::Query.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Games/Quakeworld/Query.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,33,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR></AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{Query.pm blib/lib/Games/Quakeworld/Query.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
